...
document.getElementById('incubators').addEventListener('mouseover', function () {
		this.classList.add('mine__item-hov')
})
...
document.addEventListener('DOMContentLoaded', function () {
	document
		...
		.addEventListener('click', function () {
			...
			document.getElementById('grain').classList.remove('mine__item-hov')
		})
})
...
document.addEventListener('DOMContentLoaded', function () {
	document
		...
		.addEventListener('click', function () {
			...
			document.getElementById('incubators').classList.remove('mine__item-hov')
		})
})
...
document.addEventListener('DOMContentLoaded', function () {
	document
		...
		.addEventListener('click', function () {
			...
			document.getElementById('vitamins').classList.remove('mine__item-hov')
		})
})
...
document.addEventListener('DOMContentLoaded', function () {
	document
		...
		.addEventListener('click', function () {
			...
			document.getElementById('trainer').classList.remove('mine__item-hov')
		})
})
...
document.addEventListener('DOMContentLoaded', function () {
	document
		...
		.addEventListener('click', function () {
			...
			document.getElementById('elixir').classList.remove('mine__item-hov')
		})
})
